...
public class AuthenticationServiceImpl implements AuthenticationService {
  ...
  private void generateConfirmationEmail(User user) {
    ...
    String confirmationUrlWithParams = UriComponentsBuilder.fromHttpUrl(confirmUrl).queryParam("token", token).toUriString();
    emailService.send(
            user.getEmail(),
            buildEmail(user, confirmationUrlWithParams)
    );
  }
  ...
  private String buildEmail(User user, String link) {
    return "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
            ...
            "    <p style=\"line-height: 140%;\">Hello " + user.getFirstName() + "! Thank you for registration!<br />Confirm your account:</p>\n" +
            ...
            "    <a href=\"" + link + "\" target=\"_blank\" class=\"v-button\" style=\"box-sizing: border-box;display: inline-block;font-family:'Cabin',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #6719e5; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;\">\n" +
