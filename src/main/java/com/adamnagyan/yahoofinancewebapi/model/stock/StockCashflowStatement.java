...
public class StockCashflowStatement {
  ...
  public StockCashflowStatement add(StockCashflowStatement that) {
    return StockCashflowStatement.builder()
            ...
            .totalCashflowsFromInvestingActivities(this.totalCashflowsFromInvestingActivities + that.totalCashflowsFromInvestingActivities)
            .otherCashflowsFromInvestingActivities(this.otherCashflowsFromInvestingActivities + that.otherCashflowsFromInvestingActivities)
            .totalCashFromFinancingActivities(this.totalCashFromFinancingActivities + that.totalCashFromFinancingActivities)
